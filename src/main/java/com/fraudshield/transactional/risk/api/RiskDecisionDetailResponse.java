...
public record RiskDecisionDetailResponse(
	...
	public static RiskDecisionDetailResponse from(RiskDecisionEntity decision) {
		return new RiskDecisionDetailResponse(
